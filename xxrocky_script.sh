...
U_01() {
    ...
    # JSON 출력
    echo "{" >> $resultfile
    echo "  \"id\": \"U_01\"," >> $resultfile
    echo "  \"importance\": \"상\"," >> $resultfile
    echo "  \"category\": \"카테고리 예제\"," >> $resultfile
    echo "  \"check_item\": \"점검 항목 설명\"," >> $resultfile
    echo "  \"result\": \"$result\"," >> $resultfile
    echo "  \"current_status\": \"$status\"" >> $resultfile
    echo "}," >> $resultfile
    return 0
	echo ""  >> $resultfile 2>&1
